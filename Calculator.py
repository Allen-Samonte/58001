...
#widgets start from here
        ...
        self.btnclr = Button(win, text="Clear", bg="Red", command=self.clr)
        ...
        self.btnsub = Button(win, text="Sub", command=self.sub)
        self.btnsub.place(x=200, y=200)
        #self.btnsub.bind('<Button-1>', self.sub)
        self.btnmul = Button(win, text="Multi", command=self.mul)
        self.btnmul.place(x=250, y=200)
        #self.btnmul.bind('<Button-1>', self.mul)
        self.btndiv = Button(win, text="Divi", command=self.div)
